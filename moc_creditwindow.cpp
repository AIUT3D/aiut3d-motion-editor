...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CreditWindow_t, stringdata) + ofs \
...
const QMetaObject CreditWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CreditWindow.data,
      qt_meta_data_CreditWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CreditWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreditWindow.stringdata))
        return static_cast<void*>(const_cast< CreditWindow*>(this));
